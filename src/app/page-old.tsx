        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-neutral-200 py-4 space-y-3">
              <Link href="/products" className="block text-neutral-600 hover:text-neutral-900 font-medium py-2">
                SHOP
              </Link>
              <a href="#impact" className="block text-neutral-600 hover:text-neutral-900 font-medium py-2">
                OUR IMPACT
              </a>
              <Link href="/contact" className="block text-neutral-600 hover:text-neutral-900 font-medium py-2">
                ABOUT
              </Link>
