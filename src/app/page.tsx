...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      `}</style>
      {/* Top Promo Bar */}
      <div className="hidden sticky top-0 z-50 bg-slate-950 border-t-2 border-emerald-500 animated-border">
      ...
      <nav className="bg-emerald-600 border-b border-emerald-700">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 h-16">
            ...
            {/* Search Bar */}
            <div className="hidden lg:flex flex-1 max-w-lg items-center bg-white border-0 px-4 py-2 rounded-full">
