      ...
      <nav className="sticky top-0 z-50 bg-teal-950 border-b border-teal-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* Search Bar - Center */}
            <div className="hidden lg:flex flex-1 max-w-lg items-center bg-white border-0 px-4 py-2 mx-12 rounded-full">
              <FiSearch size={18} className="text-teal-900" />
              <input
                type="text"
                placeholder="Search for products"
                className="bg-transparent text-teal-900 text-sm placeholder-emerald-300 ml-3 w-full focus:outline-none"
              />
            </div>
