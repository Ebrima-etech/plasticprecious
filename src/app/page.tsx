        ...
        <div className="relative w-full h-[55vh] flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex items-center justify-between px-2 z-20 pointer-events-none">
            <button
              ...
              className="pointer-events-auto w-10 h-10 rounded-full bg-white/80 hover:bg-white text-slate-900 flex items-center justify-center transition-all duration-300 hover:scale-110 text-2xl leading-none shadow-lg hover:shadow-xl backdrop-blur-sm">
              &lt;
            </button>
            <button
