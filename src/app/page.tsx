  ...
  return (
    <div className="min-h-screen bg-white">
      <style>{`
        ...
        .bestseller-heading {
          display: inline-block;
          background: linear-gradient(135deg, #000000 0%, #059669 50%, #10b981 100%);
          -webkit-background-clip: text;
          -webkit-text-fill-color: transparent;
          background-clip: text;
        ...
        <div className="relative w-full h-[45vh] flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex items-center justify-between px-1 z-20 pointer-events-none">
            <button
              ...
              className="pointer-events-auto w-8 h-8 rounded-full bg-white/80 hover:bg-white text-slate-900 flex items-center justify-center transition-all duration-300 hover:scale-110 text-xl leading-none shadow-lg hover:shadow-xl backdrop-blur-sm">
              &lt;
            </button>
            <button
      ...
      <section id="services" className="py-16 lg:py-24 bg-white relative overflow-hidden" style={{
        backgroundImage: `url('data:image/svg+xml,%3Csvg width="60" height="60" xmlns="http://www.w3.org/2000/svg"%3E%3Ccircle cx="10" cy="10" r="2" fill="rgba(16, 185, 129, 0.2)"/%3E%3Ccircle cx="30" cy="30" r="2" fill="rgba(16, 185, 129, 0.2)"/%3E%3Ccircle cx="50" cy="50" r="2" fill="rgba(16, 185, 129, 0.2)"/%3E%3Ccircle cx="50" cy="10" r="2" fill="rgba(16, 185, 129, 0.2)"/%3E%3Ccircle cx="10" cy="50" r="2" fill="rgba(16, 185, 129, 0.2)"/%3E%3C/svg%3E')`,
